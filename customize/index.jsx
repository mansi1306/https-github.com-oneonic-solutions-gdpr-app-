                      ...
                      <div style={{ marginLeft: '20px', marginTop: '5px' }}>
                        <div style={{ display: 'block' }}> {/* Block layout for vertical list */}
                          {regionsData[region].map((country) => (
                            <div key={country} style={{ marginBottom: '5px' }}>
                              <Checkbox
                                label={country}
                                checked={regions[region]} // Adjust according to specific country selection logic
                                onChange={() => handleCountryChange(region, country)}
                              />
                            </div>
                          ))}
                        </div>
