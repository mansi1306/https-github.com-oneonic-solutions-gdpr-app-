    ...
    useEffect(() => {
        ...
        const fetchStoreData = async () => {
            try {
              ...
              if (data.shop_name) {
                setShopName(data.shop_name); // Update state with shop_name
              }
            } catch (error) {
    ...
    const handleThemeClick = (theme) => {
        ...
        setShowCookieConsent(true); // Show cookie consent when a theme is selected
      };
