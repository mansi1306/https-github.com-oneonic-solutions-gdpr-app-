  ...
  const handlePlanSelect = async (plan) => {
    ...
    try {
      ...
      const chargeResponse = await fetch(
        "https://dab6-103-105-234-92.ngrok-free.app/shopify_app/create_charge/",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      <div style={{ marginLeft: '150px', cursor: 'pointer' }}>
        <div style={{ width: '850px' }}>
          <LegacyCard sectioned>
            ...
            <p>Block Google tracking by default until customers give consent. Google Consent Mode v2 is mandatory by March 2024 for those who use Google tracking services.</p>
        ...
        <div style={{ width: '850px', marginTop: '15px' }}>
          <LegacyCard sectioned>
            ...
            <p>Customers have the right to withdraw their consent at any time. This requirement is outlined in Article 7.3.</p>
            <div style={{ marginTop: '10px' }}>
              {isBasicPlan ? (
                <>
                  <Button disabled>Setup</Button>
                  <div style={{marginLeft:'70px',marginTop:'-25px'}}><Button onClick={openModal} variant="plain">Upgrade to unlock </Button></div>
                </>
              ) : (
        ...
        <div style={{ width: '850px', marginTop: '15px' }}>
          <LegacyCard sectioned>
            ...
            <p>Inform your customers why you’re processing their data. This requirement is outlined in Article 12.</p>
            <div style={{ marginTop: '10px' }}>
              {isBasicPlan ? (
                <>
                  <Button disabled>Setup</Button>
        ...
        <div style={{ width: '850px', marginTop: '15px' }}>
          <LegacyCard sectioned>
            ...
            <p>It is required to inform customers about data processing and ask for their consent. This requirement is outlined in recital 32.</p>
            <div style={{ marginTop: '10px' }}>
        ...
        <div style={{ width: '850px', marginTop: '15px' }}>
          <LegacyCard sectioned>
            ...
            <p>Customers can view details and choose cookie categories to give consent. This requirement is outlined in Article 13.</p>
            <div style={{ marginTop: '10px' }}>
          ...
          <TextContainer>
            ...
            <ul style={{ listStyleType: 'none', padding: 0, lineHeight: '30px' }}>
                      <li style={{ display: 'flex', alignItems: 'center' }}>
                        <img src='../assets/99.png' alt="Plan icon" width="25px" style={{ marginLeft: '0px' }} />
