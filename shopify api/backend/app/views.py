...
def shopify_auth(request):
    ...
    scopes = ['write_products', 'read_products', 'write_orders', 'read_orders','read_customers','write_customers','write_content']
    ...
    if request.method == 'POST':
        ...
        charge_data = {
            "recurring_application_charge": {
                ...
                "return_url": "https://dab6-103-105-234-92.ngrok-free.app/shopify_app/accept_charge",
                "trial_days": 7,
                "test": True,
            }
        }
...
def create_gdpr_privacy_policy_page(shop_url, access_token):
    ...
    body_html_content = f"""
                    ...
                    """
    url = f"https://{shop_url}/admin/api/2024-07/pages.json"  # Use latest API version
    headers = {
        "X-Shopify-Access-Token": access_token,
        "Content-Type": "application/json",
    }
