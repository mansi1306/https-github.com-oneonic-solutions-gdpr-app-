...
def register_webhook(shop, access_token):
    ...
    valid_webhooks = [
        ...
        },
        {
            ...
            'address': f"{settings.BASE_URL}/webhooks/customers/data_request",
            'format': 'json'
        },
        {
            'topic': 'customers/redact',
            'address': f"{settings.BASE_URL}/webhooks/customers/redact",
            'format': 'json'
        },
        {
            'topic': 'shop/redact',
            'address': f"{settings.BASE_URL}/webhooks/shop/redact",
            'format': 'json'
        }
    ]
