    ...
    const fetchAccessTokenAndPlan = async () => {
      ...
      try {
        ...
        if (!accessTokenResponse.ok) {
          const errorText = await accessTokenResponse.text(); // Read as text first
          ...
          try {
            ...
            errorData = { error: errorText }; // Fallback to text if parsing fails
          }
          console.error('Error Data:', errorData);
          
          // Handle redirection or further error handling based on status
