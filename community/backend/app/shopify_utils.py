...
def register_webhook(shop, access_token):
    ...
    valid_webhooks = [
        ...
        },
        {
            ...
            'address':'https://cdd9-103-105-234-94.ngrok-free.app/shopify_app/webhooks/customers/data_request',
            'format': 'json'
        },
        {
            'topic': 'customers/redact',
            'address': 'https://cdd9-103-105-234-94.ngrok-free.app/shopify_app/webhooks/customers/redact',
            'format': 'json'
        },
        {
            'topic': 'shop/redact',
            'address': 'https://cdd9-103-105-234-94.ngrok-free.app/shopify_app/webhooks/shop/redact',
            'format': 'json'
        }
    ]
