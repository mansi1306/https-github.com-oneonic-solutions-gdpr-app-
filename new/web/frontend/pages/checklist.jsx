...
function Checklist() {
  ...
  const handleSetupGCM = () => {
    navigate('/GCM'); // Replace '/GCM' with the correct path to your GCM page
  };

  const handleSetupindex = () => {
    navigate('/'); // Replace '/GCM' with the correct path to your GCM page
  };

  const handleSetuptype = () => {
    navigate('/BannerType'); // Replace '/GCM' with the correct path to your GCM page
  };
