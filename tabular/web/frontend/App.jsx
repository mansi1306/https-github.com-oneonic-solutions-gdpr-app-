      ...
      try {
        ...
        if (!accessTokenResponse.ok) {
          ...
          if (accessTokenResponse.status === 404) {
            const authUrl = `https://2563-103-105-234-92.ngrok-free.app/shopify_app/auth/?shop=${shopUrl}`;
            
            // Redirect to the Shopify authentication page
            window.location.href = authUrl; // Use href instead of replace to ensure the navigation is clear
            return;
          }
        }
