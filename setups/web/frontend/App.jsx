        ...
        if (!accessTokenResponse.ok) {
          ...
          if (accessTokenResponse.status === 404) {
            if (app && app.dispatch) {
              ...
              redirect.dispatch(Redirect.Action.REMOTE, `http://127.0.0.1:8000/shopify_app/auth/?shop=${shopUrl}`);
            } else {
              console.error("App Bridge instance not available for redirect.");
            }
          }            
          return;
        }
