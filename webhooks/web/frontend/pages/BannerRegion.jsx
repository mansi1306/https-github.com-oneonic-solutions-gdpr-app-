...
function CountryForm() {
  ...
  const handleIndividualChange = (setter, value) => {
    ...
    setter(value);
    if (value) {
      setAllCountries(false); // Uncheck "All countries" when an individual region is selected
    }
  };
  ...
  return (
    <div style={{width:'950px',marginLeft:'-160px'}}>
      ...
      <Card sectioned>
        ...
        <h1 style={{color:'rgb(33, 43, 92)',fontSize:'22px',fontWeight:'700',marginTop:'20px',marginBottom:'15px'}}>
          Choose region to show cookie banner</h1>
